      ...
      <div className="container">
        <div className="contact-us__wrapper">
          ...
          <p className="contact-us__text">
            cвяжемся с&nbsp;Вами в&nbsp;ближайшее время!
          </p>
          <form className="contact-us__form" onSubmit={handleSubmit(onSubmit)}>
            <div className="contact-us__field">
              <CustomInput
                type="text"
                placeholder="Имя"
                {...register("client_name", { required: "Имя обязательно" })}
              />
              {errors.client_name && (
                <span className="contact-us__error">
            ...
            {message && (
              <span
                className={`contact-us__message ${message.includes("успешно") && "contact-us__message--success"}`}
              >
                {message}
              </span>
            )}
          ...
          <div className="contact-us__info">
            ...
            <ul className="contact-us__list">
              <li className="contact-us__item">
                ...
                <a
                  className="contact-us__item-link"
              ...
              <li className="contact-us__item">
                ...
                <a className="contact-us__item-link" href="tel:+78005553535">
                  +7 (906) 744-83-36
                </a>
              </li>
              <li className="contact-us__item">
                ...
                <span className="contact-us__item-text">
                  Московская область, г. о. Воскресенск, тер. Старая
                  Промплощадка, зд. 3В
                </span>
              </li>
              <li className="contact-us__item">
