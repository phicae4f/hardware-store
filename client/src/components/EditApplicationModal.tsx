        ...
        <div className="modal" onClick={handleOverlayClick}>
            <div className="modal__wrapper">
                <div className="modal__header">
                    ...
                    <button className="modal__close-btn" type="button" onClick={onClose}><IoMdClose size={30}/></button>
                </div>
                ...
                <div className="modal__footer">
                    ...
                    <button className="modal__btn" type="button" onClick={handleSave} disabled={isLoading}>{isLoading ? "Сохранение..." : "Сохранить"}</button>
                </div>
            </div>
        </div>
    )
